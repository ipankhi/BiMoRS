...
def read_and_split_data(image_dir, p_trn=0.5, p_val=0.2, ignored=None, new_cnames=None):
    ...
    for label, category in enumerate(categories):
        ...
        # ----------------------------- making changes here, test is same as val ----------------------#
        ...
        test.extend([(img, label, classname) for img in images[n_train:n_train + n_val]])
...
def subsample_classes(*args, subsample="new"):
